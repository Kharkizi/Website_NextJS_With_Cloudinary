...
export default async function Home() {
  return (
    <main className="my-24 text-center">
      <h1 className="text-2xl text-white" >Next 13 Pages example ✨</h1>
      ...
      <div className="flex gap-2 justify-center">
        ...
        <Link className="text-black my-2 inline-block py-3 px-6 rounded-md font-bold bg-gradient-to-tr from-yellow-300 to-red-300" href="/dashboard"> Go to Dashboard</Link>
